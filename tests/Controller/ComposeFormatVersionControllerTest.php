...
class ComposeFormatVersionControllerTest extends WebTestCase
{
    public function testListGet()
    {
        $client = static::createClient();

        $client->request('GET', '/api/v1/versions');
        ...
        foreach ($responseBodyObject->data as $image) {
            ...
            $this->assertObjectHasAttribute('composeVersion', $image);
            $this->assertObjectHasAttribute('dockerEngineRelease', $image);
        }
    }
}
